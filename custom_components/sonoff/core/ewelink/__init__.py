...
# Keep genuine cloud-command failures under the protocol logger. Existing log
# filters and Home Assistant automations can therefore distinguish them from a
# response that was successfully reconciled.
