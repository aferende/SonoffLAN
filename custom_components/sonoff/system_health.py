...
class WarningPassthrough(logging.Handler):
    """Forward only actionable records to Home Assistant's root handlers."""
...
class DebugView(logging.Handler, HomeAssistantView):
    ...
    def __init__(self, logger: Logger):
        ...
        # The debug endpoint keeps a bounded in-memory trace. Do not propagate
        # high-frequency protocol records to Home Assistant's raw logs. Warnings
        # and errors are forwarded by WarningPassthrough above.
